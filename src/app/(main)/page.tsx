...
export default function Home() {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative w-full max-w-360 mx-auto px-6 md:px-12 pt-24 pb-16 md:pt-40 md:pb-24 flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          >
            Lingkungan yang tepat <br className="hidden lg:block" />
            bisa mengubah segalanya
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="text-[#657668] text-[16px] xl:text-[18px] max-w-115 mx-auto md:mx-0 mb-10 leading-relaxed font-medium"
          >
        ...
        >
          <div className="relative w-full max-w-125 aspect-4/5 rounded-[48px] overflow-visible">
            <Image
              src="/images/hero.png"
            ...
            >
              <span className="text-2xl font-extrabold text-[#523824] -rotate-[10deg]">
                12k+
              </span>
              <span className="text-[11px] font-bold tracking-wider text-[#7a5940] mt-1 -rotate-[10deg]">
                MEMBER
              </span>
            </motion.div>
          </div>
      ...
      <section
        id="tentang-kami"
        className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-20 lg:py-28"
      >
        <motion.h2
          initial="hidden"
          whileInView="visible"
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center overflow-hidden">
          ...
          >
            <p>
              Komunitas Teman tumbuh adalah komunitas yang menjadi wadah
              pertemuan antar individu yang memiliki warna yang sama. baik itu
              dari tujuan dan arah, background dan kesamaan hobi. komunitas ini
              akan menciptakan lingkungan yang positif yang saling menguatkan
              dan bertumbuh berkembang bersama.
            </p>
          </motion.div>
          <motion.div
            initial="hidden"
          ...
          >
            ...
            >
              ...
              <p className="text-[#d8ebd] text-white text-[18px] lg:text-[20px] font-medium leading-relaxed max-w-[400px] z-10 mx-auto">
                &quot;Kami percaya bahwa setiap benih memiliki potensi luar
                biasa, hanya jika diberikan tanah yang subur dan sinar matahari
                yang cukup.&quot;
              </p>
            </motion.div>
          </motion.div>
      ...
      <section
        id="visi-misi"
        className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-10 lg:py-20"
      >
        <motion.h2
          initial="hidden"
          whileInView="visible"
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start overflow-hidden">
          ...
          >
            {/* Visi */}
            <motion.div variants={fadeInUp}>
              <h3 className="text-2xl font-bold text-[#142018] mb-6 tracking-tight">
                Visi :
              </h3>
              <div className="flex items-start gap-5 lg:gap-6 group">
                ...
                <p className="text-[#556658] text-[15px] lg:text-[16px] leading-relaxed font-medium mt-1">
                  Menjadi ekosistem pembelajaran yang inklusif dan berkelanjutan
                  dalam mengembangkan potensi individu melalui pendidikan
                  non-formal, pembentukan mindset produktif, serta kolaborasi
                  yang luas untuk menciptakan masa depan yang lebih baik.
                </p>
              </div>
            </motion.div>
          ...
          >
            <motion.div
              whileHover={{
                y: -10,
                boxShadow: "0 25px 50px -12px rgba(250,220,108,0.4)",
              }}
            ...
            >
              ...
              <p className="text-[#6d4d38] text-[20px] lg:text-[23px] font-bold leading-snug tracking-tight">
                &quot;Tumbuh bukan tentang seberapa cepat, tapi seberapa dalam
                akar kita menghujam.&quot;
              </p>
            </motion.div>
          </motion.div>
      ...
      <section className="bg-[#f6f9f5] w-full py-20 lg:py-28 mt-10">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <motion.div variants={fadeInUp}>
              <h2 className="text-4xl lg:text-[44px] font-bold italic text-[#34513a] mb-4 tracking-tight">
                Agenda Mendatang
              </h2>
              <p className="text-[#657668] text-[15px] lg:text-[16px] max-w-lg font-medium leading-relaxed">
                Ruang-ruang aman yang telah kami siapkan untuk perjalananmu
                minggu ini. Mari bertemu dan bertukar energi.
              </p>
            </motion.div>
            <motion.div variants={fadeInUp}>
              <Link
                href="/jadwal-aktivitas"
                className="inline-flex items-center gap-2 text-[#465a4c] font-bold text-[14px] hover:text-[#2d4632] group overflow-hidden"
              >
                Lihat Semua Jadwal
                <motion.div
                  whileHover={{ x: 5 }}
          ...
          >
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <span className="bg-[#486a4e] text-white px-5 py-2 rounded-full text-[14px] font-bold shadow-sm">
                  Rabu
                </span>
                <Calendar size={22} className="text-[#a1afa4]" />
              </div>
              <h4 className="text-[22px] font-semibold text-[#25362a] mb-3">
                English with V
              </h4>
              <p className="text-[#6c7d70] text-[13px] leading-relaxed mb-6 flex-1">
                Merawat ambisi karir dan mimpi menjelajah dunia lewat obrolan
                bahasa asing yang seru di bawah bimbingan fasilitator kami.
              </p>
            ...
            >
              <div className="flex justify-between items-start mb-6 w-full">
                <span className="bg-[#fbe57e] text-[#554016] px-5 py-2 rounded-full text-[14px] font-bold shadow-sm">
                  Jumat
                </span>
                <motion.span
              ...
              <p className="text-[#6c7d70] text-[13px] leading-relaxed mb-6 flex-1">
                Hadirkan puisi yang merangkum keresahanmu dan suarakan emosi
                yang selama ini tertahan di hadapan puluhan telinga yang peduli.
              </p>
              <div className="flex flex-col gap-2 mb-8 text-[12px] font-semibold text-[#546859]">
                <div className="flex items-center gap-2">
                  <svg
            ...
            <motion.div
              variants={fadeInUp}
              whileHover={{ y: -12, scale: 1.02 }}
              className="bg-white rounded-3xl p-7 flex flex-col relative overflow-hidden transition hover:shadow-md border border-[#e8efe9]"
            >
              <div className="flex justify-between items-start mb-6">
                <span className="bg-[#c2e4c9] text-[#2b4c34] px-5 py-2 rounded-full text-[14px] font-bold shadow-sm">
                  Sabtu
                </span>
                <Calendar size={22} className="text-[#a1afa4]" />
              </div>
              ...
              <p className="text-[#6c7d70] text-[13px] leading-relaxed mb-6 flex-1">
                Adu argumen lewat ragam obrolan tanpa batas dan temukan sudut
                pandang baru yang mencerahkan dalam lingkar diskusi yang hangat
                dan terbuka.
              </p>
              <div className="flex flex-col gap-2 mb-8 text-[12px] font-semibold text-[#546859]">
                <div className="flex items-center gap-2">
      ...
      <section className="w-full px-6 md:px-12 py-24 mb-16 relative">
        <motion.div
          ...
          className="max-w-275 mx-auto rounded-[40px] bg-linear-to-br from-[#405c45] to-[#283e2c] px-8 py-20 lg:py-24 text-center text-white relative shadow-2xl overflow-hidden flex flex-col justify-center items-center"
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl md:text-5xl lg:text-[54px] font-medium leading-[1.2] mb-10 tracking-tight z-10 max-w-200 text-[#e0e8e2]"
          >
          ...
          <motion.div variants={fadeInUp} className="z-10 w-full max-w-105">
          ...
          <div className="absolute bottom-[-50%] right-[-10%] w-[60%] h-full bg-[#213525] blur-[100px] opacity-60 rounded-full z-0"></div>
        </motion.div>
      </section>
    </div>
  );
